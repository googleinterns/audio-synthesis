...
checkpoint_dir = 'results/WaveGAN_RWD/training_checkpoints/'
...
def generate_and_save_audio(model, epoch, test_input):
    ...
    sf.write('results/WaveGAN_RWD/audio/' + str(epoch) + '.wav', generations, 16000)
...
def train():
    ...
    for epoch in range(EPOCHS):
        pb_i = Progbar(13343, interval=30)
        start = time.time()
