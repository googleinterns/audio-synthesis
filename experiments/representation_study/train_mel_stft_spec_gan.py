...
CHECKPOINT_DIR = '_results/representation_study/melSTFTSpecGAN_HR/training_checkpoints/'
RESULT_DIR = '_results/representation_study/melSTFTSpecGAN_HR/audio/'
...
def main():
    ...
    raw_dataset = waveform_dataset.get_stft_dataset(
        ...
        n_mel_bins=N_MEL_BINS, mel_lower_hertz_edge=MEL_LOWER, mel_upper_hertz_edge=MEL_UPPER
    )
